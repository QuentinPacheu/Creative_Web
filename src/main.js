...
function dessinerAiguilles() {
    ...
    // Ajustement de l'angle pour positionner l'aiguille des heures entre le 5 et le 6
    const angleHeuresAjuste = angleHeures + (5.5 * 2 * Math.PI / 12 - angleHeures) % (2 * Math.PI / 12);
    ...
    ctx.lineTo(centreX + rayon / 2 * Math.cos(angleHeuresAjuste), centreY + rayon / 2 * Math.sin(angleHeuresAjuste));
    ctx.stroke();
